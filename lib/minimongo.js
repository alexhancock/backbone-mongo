...
// XXX tests
LocalCollection.prototype.find = function (selector, options, byId) {
  ...
  return new LocalCollection.Cursor(this, selector, options, byId);
};

// don't call this ctor directly.  use LocalCollection.find().
LocalCollection.Cursor = function (collection, selector, options, byId) {
  var self = this;
...
LocalCollection.prototype.findOne = function (selector, options, byId) {
  if (arguments.length === 0)
    selector = {};
  ...
  return this.find(selector, options, this._byId).fetch()[0];
};
...
LocalCollection.prototype.update = function (selector, mod, options, byId) {
  var self = this;
  if (!options) options = {};
